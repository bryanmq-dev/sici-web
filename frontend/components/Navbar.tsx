...
const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Cursos', href: '/courses', icon: BookOpen, desc: 'Formación contínua' },
      ...
      { name: 'Programación Competitiva', href: '/comunidad/programacion-competitiva', icon: Code2, desc: 'Próximamente' },
      { name: 'AWS Student Group', href: '/comunidad/aws-student-group', icon: Cloud, desc: 'Próximamente' },
      { name: 'Ciberseguridad', href: '/comunidad/ciberseguridad', icon: Shield, desc: 'Próximamente' },
      { name: 'Voluntariado', href: '/comunidad/voluntariado', icon: HeartHandshake, desc: 'Próximamente' },
      { name: 'ISI Sports', href: '/comunidad/isi-sports', icon: Dumbbell, desc: 'Próximamente' },
    ]
  },
  {
    name: 'Sociedad',
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-display font-bold tracking-tight text-text-primary leading-none">SICI</span>
                <span className="text-[10px] font-mono text-text-muted leading-none mt-0.5">UNIVALLE</span>
              </div>
            </Link>
          </div>
                          ...
                          {item.children.map((child) => (
                            ...
                            >
                              <div className="w-8 h-8 flex items-center justify-center rounded-lg bg-surface-muted">
                                <child.icon className={cn("w-4 h-4", pathname === child.href ? "text-primary" : "text-text-secondary")} />
                              </div>
                              <div>
                                <div className={cn("text-sm font-medium", pathname === child.href ? "text-primary" : "text-text-primary")}>
                                  {child.name}
                                </div>
